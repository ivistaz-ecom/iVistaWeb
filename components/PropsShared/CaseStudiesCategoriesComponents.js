...
import { Container, Col, Image, CloseButton, Row } from "react-bootstrap";
        ...
        <Col className="d-flex flex-column justify-content-center gap-5">
          {data ? ( // Check if data is available
            ...
            <div className="text-white d-flex flex-column justify-content-center align-items-center">
              <div className="spinner-border app" role="status"></div>
          ...
          {isOpen && (
            <div className="position-fixed top-0 start-0 end-0 bottom-0 z-index-100 d-flex flex-column justify-content-center align-items-center bg-black bg-opacity-75 mx-lg-0 mx-2">
              ...
              <div className="position-relative bg-white h-80vh rounded-3 overflow-auto z-index-100 pop-box">
                <div
                  className="position-absolute end-0 p-4 pe-5 top-0"
                  onClick={handleCloseModal}
                >
                    ...
                    <>
                      <div className="d-flex flex-column justify-content-between p-0">
                        <div>
                          ...
                          <div
                            className="case-text text-start"
                            dangerouslySetInnerHTML={{
